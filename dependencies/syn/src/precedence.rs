...
impl Precedence {
    ...
    pub(crate) fn of(e: &Expr) -> Self {
        ...
        match e {
            ...
            | Expr::View(_)
            | Expr::GetField(_)
            | Expr::Here(_) => Precedence::Unambiguous,
...
impl Associativity {
    pub(crate) fn of(precedence: Precedence) -> Self {
        match precedence {
            Precedence::Assign | Precedence::Imply => Associativity::Right,
            Precedence::Jump | Precedence::Equiv => Associativity::None,
            Precedence::Range
            | Precedence::Exply
            | Precedence::Or
            | Precedence::And
            ...
            | Precedence::HasIsMatches
            | Precedence::Prefix
            | Precedence::Unambiguous => Associativity::Left,
        }
    }
}
