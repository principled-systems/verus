    ...
    'tcx: 'a,
{
    ...
    match verus_item {
        ...
        VerusItem::UnaryOp(UnaryOpItem::SpecGhostTracked(SpecGhostTrackedItem::GhostBorrowMut)) => {
            ...
            let modif = ExprModifier {
                deref_mut: adjusted_is_ref_mut || outer_modifier.deref_mut,
                ..outer_modifier
            };
...
fn mk_vir_args<'tcx>(
    ...
    args.iter()
        ...
        .map(|(arg, _raw_param)| {
            ...
            let adjusted_expr_typ_is_mut_ref =
                is_expr_typ_mut_ref(bctx.types.expr_ty_adjusted(arg));
